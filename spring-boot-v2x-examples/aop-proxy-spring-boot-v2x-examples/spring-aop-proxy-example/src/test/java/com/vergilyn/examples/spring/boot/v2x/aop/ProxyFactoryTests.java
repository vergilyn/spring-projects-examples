package com.vergilyn.examples.spring.boot.v2x.aop;
...
public class ProxyFactoryTests {
     ...
     */
    @Test
    public void helloworld(CapturedOutput capturedOutput) {
        ...
        assertThat(capturedOutput.getOut())
                .containsSubsequence(
                        "MethodBeforeAdvice >>>> sayHello",
                        "#sayHello(name)",
                        "AfterReturningAdvice >>>> method-name: sayHello, returnValue: hello, world.",
                        "hello, world."
                );
    }
